      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="bg-white rounded-3xl shadow-lg shadow-gray-200/50 p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3.5 rounded-xl border ${errors.name ? 'border-red-400 ring-2 ring-red-100' : 'border-gray-200 focus:border-indigo-400'} focus:outline-none focus:ring-2 focus:ring-indigo-100 transition-all bg-gray-50/50`}
            ...
            <div>
              ...
              <input
                type="password"
                placeholder="••••••••"
                className={`w-full px-4 py-3.5 rounded-xl border ${errors.confirmPassword ? 'border-red-400 ring-2 ring-red-100' : 'border-gray-200 focus:border-indigo-400'} focus:outline-none focus:ring-2 focus:ring-indigo-100 transition-all bg-gray-50/50`}
          ...
          <p className="text-center text-gray-500 text-sm mt-6">
            ...
            <Link to="/login" className="text-indigo-600 font-semibold hover:text-indigo-700 hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
